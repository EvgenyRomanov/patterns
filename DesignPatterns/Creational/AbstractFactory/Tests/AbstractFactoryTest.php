...
use PHPUnit\Framefork\TestCase;
...
class AbstractFactoryTest extends TestCase
{
    ...
    {
        $this->assertIstanceOf(JsonWriter::class, $writerFactroy->createJsonWriter());
        $this->assertIstanceOf(CsvWriter::class, $writerFactroy->createCsvWriter());
    }
}